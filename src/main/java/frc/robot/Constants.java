...
public final class Constants {
    ...
    public static final class Drive {
        ...
        public static final class Auton {
            ...
            public final static DifferentialDriveKinematics driveKinematics = new DifferentialDriveKinematics(
                    trackWidth);
        ...
        public static final class TrajectorySettings {
            DifferentialDriveVoltageConstraint autoVoltageConstraint = new DifferentialDriveVoltageConstraint(
                    new SimpleMotorFeedforward(Drive.Auton.ksVolts, Drive.Auton.kvVoltSecondsPerMeter,
                            Drive.Auton.kaVoltSecondsSquaredPerMeter),
                    Drive.Auton.driveKinematics, 10);

            TrajectoryConfig config = new TrajectoryConfig(Drive.Auton.MAX_SPEED, Drive.Auton.MAX_ACCELERATION)
                    .setKinematics(Drive.Auton.driveKinematics).addConstraint(autoVoltageConstraint);
        }
    }
